	...
	public class DemoController {
		...
		public String demo() {
			return "<body bgcolor='red' text='yellow'><center><h1>I am Surya</h1></center></body>";
		}

		// @RequestMapping(value = "/second", method = RequestMethod.GET)
		@GetMapping("/second")
		public String demo2() {
			return "<body bgcolor='yellow' text='red'><center><h1>I am Suryakanta</h1></center></body>";
		}
...
//		@GetMapping("/fullname")
//		public String createFullName(@RequestParam(name = "name", required = false, defaultValue = "Suryakanta") String name,
//				@RequestParam(name = "title", required = false, defaultValue = "Maharik") String title) {
	//
